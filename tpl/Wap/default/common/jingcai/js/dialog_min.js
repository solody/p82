var iDialog = (function() {
    var c = '<header>						<dl>							<dd><label>{title}</label></dd>							<dd><span onclick="this.parentNode.parentNode.parentNode.parentNode.classList.remove(\'on\');">{close}</span></dd>						</dl>					</header>					<article class="dialogContent">{content}</article>					<footer></footer>';
    var b = {
        wrapper: null,
        cover: null,
        lastIndex: 1000,
    ...
    a.prototype = {
        ...
        open: function(f) {
            ...
            if (this.options.btns.length) {
                ...
                this.options.wrapper.querySelectorAll("footer")[0].appendChild(h);
            }
            return this;
        },
        show: function() {
