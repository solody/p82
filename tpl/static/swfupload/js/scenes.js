...
function addImage(src){
    ...
    var newElement = '<tr><td style="width:130px"><img src="'+src+'"></td><td><input type="text" name="sort_'+addnum+'" value="0" class="px" style="width:50px;" /></td><td><input class="px" style="width:250px;" type="text" name="picurl_'+addnum+'" id="pic_'+addnum+'" value="'+src+'" /> &nbsp; <a href="javascript:viewImg('+"'"+'pic_'+addnum+"'"+')">预览</a></td><td><input class="checkbox" type="checkbox" name="status_'+addnum+'" value="1" checked /></td><td class="norightborder"><a href="javascript:;" id="delBtn" >删除</a></td></tr>';
