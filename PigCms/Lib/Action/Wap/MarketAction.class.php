...
/*--------------------------------商圈首页------------------------------------------*/
		...
		public function maps(){
			...
			if (!$this->isamap){
				...
				$link=$this->amap->getPointMapLink($this->thisMarket['longitude'],$this->thisMarket['latitude'],$this->thisMarket['name']);
...
/*-----------------------------商户首页-------------------------------------------*/
		...
		public function tenant_maps(){
			...
			if (!$this->isamap){
				...
				$link=$this->amap->getPointMapLink($tenant['longitude'],$tenant['latitude'],$tenant['name']);
				header('Location:'.$link);
			}
		}
