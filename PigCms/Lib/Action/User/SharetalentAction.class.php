   ...
   /**删除活动**/
	...
	public function userdel(){
       ...
       if($info){
                    ...
                    $this->success('删除成功',U('Sharetalent/user',array('token'=>$token,'wecha_id'=>$wecha_id,'id'=>$pid)));}
                    else{
                   $this->error('删除失败,请稍候再试',U('Sharetalent/user',array('token'=>$token,'wecha_id'=>$wecha_id,'id'=>$pid)));
                }
