...
class YmlAction extends UserAction{
	...
	public function index(){
        ...
        if ($yml_data == null) {
            ...
            $yml_data['username'] = '';
            $yml_data['secret'] = '';
            $yml_data['print_enable'] = 0;
            $yml_data['wx_appid'] = '';
            $yml_data['wx_appsecret'] = '';
            $yml_data['voice_enable'] = 0;

            if(IS_POST){
                $_POST['token'] = session('token');
                $_POST['print_enable'] = intval($_POST['print_enable']) != 0 ? 1 : 0;
                $_POST['voice_enable'] = intval($_POST['voice_enable']) != 0 ? 1 : 0;
