...
case "move" :
    ...
    if(count($_SESSION['flist'])<1)
    {
        ...
        echo "[<a href=\"./dlym.php?path=".urlencode($getcwd)."\">返回</a>]抱歉，没有文件列表！\n";
        echo "</div>\n";
    }
    else
    {
        echo "<div class=\"like\">\n";
        echo "<a href=\"./dlym.php?path=".urlencode($getcwd)."&multiple=$type\">选择路径</a>(目标目录)\n";
        echo "</div>\n";
        echo "<div class=\"love\">\n";
...
case "pkzip" :
    ...
    else
    {
        ...
        echo "<div class=\"like\">\n";
        echo "<a href=\"./dlym.php?path=".urlencode($getcwd)."&multiple=$type\">存放目录</a>(归档路径)\n";
        echo "</div>\n";
        echo "<div class=\"love\">\n";
...
case "chmod" :
    ...
    {
        echo "<div class=\"like\">\n";
        echo "<a href=\"./dlym.php?path=".urlencode($getcwd)."\">文件列表</a>(返回浏览)\n";
        echo "</div>\n";
        echo "<div class=\"love\">\n";
...
case "delete" ;
    ...
    {
        echo "<div class=\"love\">\n";
        echo "[<a href=\"./dlym.php?path=".urlencode($getcwd)."\">返回</a>]\n";
...
case "sendfile" :
    ...
    {
        echo "<div class=\"like\">\n";
        echo "<a href=\"./dlym.php?path=".urlencode($getcwd)."\">返回目录</a>(接收邮箱)\n";
        echo "</div>\n";
        echo "<div class=\"love\">\n";
