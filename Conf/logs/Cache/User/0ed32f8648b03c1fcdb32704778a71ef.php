	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr bgcolor="#F1F1F1">
			...
			<td>
                ...
                菜单图标码<input id="emoji_code" class="txt" size="8" name="emoji_code" title="主菜单前小图标" value="" type="text"> 
				比如：e022  <a href="/tpl/static/emoji" target="_blank"><img src="<?php echo RES;?>/images/help.png" class="vm helpimg" title="菜单图标码"></a>
				</div>
