...
<div class="box">
    ...
    <p>官方网站：<a href="#" class="blue"><?php echo C('site_name');?></a></p>
   ...
   <li>
     <p class="red">您的程序版本为：pigcms微信营销系统V8.2二次开发版</p>
   </li>



   <li style="display:none"><p class="red" style="display:none">您的程序版本为：pigcms微信营销系统V8.2二次开发版</p><span style="display:none">[ 授权版本：商业版 (终身免费) ]</span></li>
